...
const htmlContent = fs.readFileSync('generate_pdf.html', 'utf8');

// Créer une version simplifiée pour conversion en PDF
...
// Écrire le fichier HTML simplifié
fs.writeFileSync('documentation_technique_simple.html', simplifiedHtml);

console.log('Documentation HTML créée: documentation_technique_simple.html');
